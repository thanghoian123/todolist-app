...
import {
  ...
  IProjectTaskAdd,
  ITaskMoveParams,
  ProjectAddTaskRequestBody,
  ProjectAddUserRequestBody,
  ProjectMoveTaskRequestBody
} from "../authorization";
...
export class ProjectController {
  ...
  async addUser(
    ...
    const a = this.projectUserRepository.create({
  ...
  async moveTask(
    ...
    //   console.log(
    //     "🚀 ~ file: project.controller.ts ~ line 91 ~ ProjectController ~ taskId",
    //     taskId
    //   );
    //   // this.myCronJob.addCallback(() => {
    //   //   console.log("call backkkkkk");
    //   // });
    // }
    return result;
  ...
  @get("/projects", {
    responses: {
      "200": {
        ...
        content: {
          "application/json": {
            schema: { type: "array", "x-ts-type": Project },
          },
        },
      },
    },
